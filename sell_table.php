...
<body>
    ...
    <div class="container" style="text-align: center;">
        <h2 class="color-black">Study Table Details</h2>
        <form class="form-horizontal" action="sell_table.php" method="post" enctype="multipart/form-data">
            <div class="form-group">
                <label class="control-label col-sm-2 color-white" for="table_name" >Table name</label>
            <div class="col-sm-10">
                <input type="text" class="form-control" id="table_name" placeholder="Table Name" name="table_name" required></div>
            </div>
            <div class="form-group">
                <label class="control-label col-sm-2 color-white" for="table_color" >Table Color</label>
            <div class="col-sm-10">
                <input type="text" class="form-control" id="table_color" placeholder="Table Color" name="table_color" required></div>
            </div>
            <div class="form-group">
                <label class="control-label col-sm-2 color-white" for="table_material" >Table Material</label>
            <div class="col-sm-10">
                <input type="text" class="form-control" id="table_material" placeholder="Table Material" name="table_material" required></div>
            </div>
            <div class="form-group">
