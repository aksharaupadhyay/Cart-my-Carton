...
<body>
    ...
    <div class="container" style="text-align: center;">
        <h2 class="color-black">Cooler Details</h2>
        <form class="form-horizontal" action="sell_cooler.php" method="post" enctype="multipart/form-data">
            <div class="form-group">
                <label class="control-label col-sm-2 color-white" for="cooler_model" >Cooler Model</label>
            <div class="col-sm-10">
                <input type="text" class="form-control" id="cooler_model" placeholder="Cooler Model" name="cooler_model" required></div>
            </div>
            <div class="form-group">
                <label class="control-label col-sm-2 color-white" for="cooler_color" >Cooler Color</label>
            <div class="col-sm-10">
                <input type="text" class="form-control" id="cooler_color" placeholder="Cooler Color" name="cooler_color" required></div>
            </div>
            <div class="form-group">
                <label class="control-label col-sm-2 color-white" for="cooler_material" >Cooler Material</label>
            <div class="col-sm-10">
                <input type="text" class="form-control" id="cooler_material" placeholder="Cooler Material" name="cooler_material" required></div>
            </div>
            <div class="form-group">
