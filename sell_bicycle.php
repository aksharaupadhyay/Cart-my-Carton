...
<body>
    ...
    <div class="container" style="text-align: center;">
        <h2 class="color-black">Bicycle Details</h2>
        <form class="form-horizontal" action="sell_bicycle.php" method="post" enctype="multipart/form-data">
            <div class="form-group">
                <label class="control-label col-sm-2 color-white" for="cycle_name" >Cycle model</label>
            <div class="col-sm-10">
                <input type="text" class="form-control" id="cycle_name" placeholder="Cycle_model" name="cycle_name" required></div>
            </div>
            <div class="form-group">
                <label class="control-label col-sm-2 color-white" for="cycle_color" >Cycle Color</label>
            <div class="col-sm-10">
                <input type="text" class="form-control" id="cycle_color" placeholder="Cycle_color" name="cycle_color" required></div>
            </div>
            <div class="form-group">
